    ...
    <div className="h-full flex items-center justify-center bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-1/2 left-10">
          <Volume2 className="h-20 w-20 animate-pulse" style={{ animationDelay: '1s' }} />
        </div>
      </div>
      ...
      <div className="text-center z-10 max-w-5xl px-8">
        ...
        {/* Date */}
        <div className="mt-12 animate-slide-in-up" style={{ animationDelay: '0.9s' }}>
        ...
        {/* Decorative Elements */}
        <div className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce" style={{ animationDelay: '2s' }}>
